...
//        viewModel.getConversationsLiveData().observe(getViewLifecycleOwner(), conversationWrappers -> {
...
//                viewModel.listenRecentConversation(user.getConversationList());
            } else {
...
//                hideShimmer();
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            if(viewModel.getCurrentUser().getValue() != null) {
                shimmerListener.onNext(true);
//                viewModel.listenRecentConversation(viewModel.getCurrentUser().getValue().getConversationList());
