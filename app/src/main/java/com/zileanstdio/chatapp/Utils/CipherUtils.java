...
public class CipherUtils {
    ...
    public static class Base64 {
        ...
        public static byte[] decode(String input) {
            return input != null ? android.util.Base64.decode(input, android.util.Base64.DEFAULT) : null;
        }

        public static String encode(byte[] buffer) {
            return buffer != null ? android.util.Base64.encodeToString(buffer, android.util.Base64.DEFAULT) : null;
        }
